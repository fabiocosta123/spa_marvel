    ...
    return (
        ...
        <div className="justify-self-end flex justify-items-end items-center">
            <form className="relative w-64">
                <input className="w-full bg-black border border-white rounded py-1 px-3 transition-all duration-300 ease-in-out opacity-0 hover:opacity-100 focus:opacity-100" type="text" placeholder="títulos, autor, gênero" />
            ...
            <div className="relative flex ml-4">
                ...
                <ul className={`absolute mt-10 top-0 right-0 w-32 bg-black rounded p-4 transition-all duration-500 ease-in-out ${!menuOpen && "opacity-0 invisible"}`}>
                    <li><a href="#account" onClick={handleCaretClick}>Minha Conta</a></li>
                    <li><a href="#logout" onClick={handleCaretClick}>Sair</a></li>
                </ul>
            </div>
